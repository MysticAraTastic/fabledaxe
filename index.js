...
const searcher = new YTSearcher({
    key: 'AIzaSyBs81L4RfgKrgxuaWBprm4U-FcrhdjOG3g',
    revealed: true
});
    ...
    function Loop(args, serverQueue){
        ...
        switch(args[0].toLowerCase()){
            ...
            case 'off':
                ...
                break;
            default:
                message.channel.send('Please specify what kind of loop you want or that you want to finish the loop. *loop <all/one/off>');
        } 
...
client.login('ODIxMjA1MzAxOTMxOTMzNzAx.YFAVCQ.0s1o1gVBsI1OIOYwTKqKPXUhkH0')